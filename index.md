...
identifies statistical patterns that exist but remain inactive until
specific trigger conditions emerge.
...
- **Biological dormancy**: Seeds remaining dormant until conditions are
  right
...
Finds patterns that are conditionally suppressed - active only under
specific conditions.
...
Finds patterns that could trigger chain reactions through other
variables.
...
This package develops a novel statistical framework inspired by concepts
from biology, geology, and epidemiology. The idea of dormant patterns in
data analysis provides a new perspective on hidden relationships and
latent risks.
